...
".'<script src="https://cdn.bootcss.com/jquery/3.2.1/jquery.min.js"></script>
     ...
     <body style="background-color: #f8f8f8;">
        <div class="w3-container w3-red w3-center" style="height:33px">
...
switch (@$_SERVER['PATH_INFO']) {
    ...
    <p>不能观看请刷新,多试几次，若页面一直处于加载状态或没有数据，请关闭重新打开！</p>
       ...
       echo '<div class="w3-container w3-center bfq">
            <iframe width="50%" height="100%" src="https://'.$_SERVER['SERVER_NAME'].'/Proxy.php?https://www.youtube.com/embed/'.trim($_SERVER[QUERY_STRING]).'" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
        </div>'; 
        echo $footer;
        break;
